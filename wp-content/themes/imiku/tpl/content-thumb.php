...
$class = ($i%2 == 0) ? 'post-list-thumb-left mdui-hoverable mdui-shadow-2' : ''; // 如果为偶数
...
?>
	<article class="post post-list-thumb mdui-hoverable mdui-shadow-2<?php echo $class; ?>" itemscope="" itemtype="http://schema.org/BlogPosting">
